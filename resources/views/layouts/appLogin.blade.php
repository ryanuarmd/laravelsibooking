...
<body style="background:url(7.jpg); background-size:cover; background-repeat: no-repeat, repeat; background-position: center; height: 600px;applogi">
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a style='font-size: 35px; font-weight: 60; color: #228B22 !important; background-color: transparent;' class="nav-link" href="{{ route('login') }}">System Booking </a>
                            </li>
