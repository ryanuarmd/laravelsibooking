    ...
    <div id="app" style="background-color: black">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm m-0 ;">
            <div class="container">
                <a style='font-size: 35px; font-weight: 100px;'class="navbar-brand" href="{{ url('/') }}">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="/users/{{ Auth::user()->id}}/edit" >Edit Profile <i class="fas fa-edit"></i>
                                    </a>
